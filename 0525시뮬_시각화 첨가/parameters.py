...
def load_fixed_customers():
    df_수요 = pd.read_excel("C:\\Users\\sking\\Desktop\\졸작\\bus_25(10-16).xlsx")[['정류장_ID', '일', '10', '11', '12', '13', '14', '15', '16']]
    df_하차비율 = pd.read_csv("C:\\Users\\sking\\Desktop\\졸작\\승하차정류장_ID.csv")
    시간대들 = ['10', '11', '12', '13', '14', '15', '16']
