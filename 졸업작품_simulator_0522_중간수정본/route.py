...
with open(r"C:\Users\User\Downloads\distance_map_UPDATED.txt", "r", encoding="utf-8") as f:
    raw_text = f.read()
...
def get_distance_between(stop1, stop2):
    ...
    return distance_matrix.get((stop1, stop2)) or distance_matrix.get((stop2, stop1)) or 0
'''
def get_distance_between(stop1, stop2):
    # 간단한 예시용 거리 계산
    if stop1 == stop2:
